...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> findByCategoria(@PathVariable String categoria) {
    ...
    public ResponseEntity<?> searchProducts(@RequestBody String query) {
    ...
    // public ResponseEntity<?> save(@RequestBody ? product) {
    ...
    // public ResponseEntity<?> update(@RequestBody ? product) {
